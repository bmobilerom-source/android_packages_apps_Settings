...
public class AtomichubCardsPreference extends Preference {
    ...
    public void onBindViewHolder(PreferenceViewHolder holder) {
        ...
        bindRunnableCard(holder, R.id.mctheme, () ->
                com.bmobile.fragments.ArcaneChatController.launch(findActivity(getContext())));
    }
    ...
    private void bindAppCard(PreferenceViewHolder holder, int viewId, String packageName,
            String className) {
        bindRunnableCard(holder, viewId, () -> launchApp(packageName, className));
    }

    private void bindRunnableCard(PreferenceViewHolder holder, int viewId, Runnable action) {
        View v = findCardView(holder, viewId);
        if (v == null) {
            return;
        }
