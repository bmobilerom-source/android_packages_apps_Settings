...
public class ManageDeviceControlsPreferenceController extends BasePreferenceController {

    public ManageDeviceControlsPreferenceController(Context context, String preferenceKey) {
    ...
    public boolean handlePreferenceTreeClick(androidx.preference.Preference preference) {
        ...
        Intent intent = DeviceControlsUtils.newControlsPanelIntent();
