...
public class KidsSafeExpressiveSettings extends SettingsPreferenceFragment {

    @Override
    public void onCreate(Bundle icicle) {
        super.onCreate(icicle);
        try {
            addPreferencesFromResource(R.xml.kidssafe_expressive_settings);
        } catch (Exception e) {
            android.util.Log.e("KidsSafeExpressiveSettings", "Error in onCreate", e);
        }
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        try {
            ...
            androidx.preference.Preference layoutPref = screen.findPreference("kidssafe_expressive_grid");
            if (layoutPref == null || !(layoutPref instanceof com.android.settingslib.widget.LayoutPreference)) {
                android.util.Log.e("KidsSafeExpressiveSettings", "kidssafe_expressive_grid LayoutPreference not found");
                return;
            }
            ...
            if (rv == null) {
                android.util.Log.e("KidsSafeExpressiveSettings", "kidssafe_expressive_grid_recycler RecyclerView not found");
                // Try to find it with a delay
                rootView.postDelayed(() -> {
                    androidx.recyclerview.widget.RecyclerView delayedRv = lp.findViewById(R.id.kidssafe_expressive_grid_recycler);
                    if (delayedRv != null) {
