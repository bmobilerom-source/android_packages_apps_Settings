...
public class HomepageWidgetsFragment extends SettingsPreferenceFragment {

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        addPreferencesFromResource(R.xml.homepage_widgets_screen);
    }
    ...
    private void bindWidgets() {
        ...
        Preference pref = screen.findPreference("homepage_widgets_layout");
