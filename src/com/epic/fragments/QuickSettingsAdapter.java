...
class QuickSettingsAdapter extends RecyclerView.Adapter<QuickSettingsAdapter.CardVH> {
    ...
    QuickSettingsAdapter(Context context, List<CardItem> items, int sourceMetrics) {
    ...
    public CardVH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.grid_card_left, parent, false);
