...
public class TopLevelSettingsGrid extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle icicle) {
        ...
        try {
            addPreferencesFromResource(R.xml.top_level_settings_grid);
        } catch (Exception e) {
            android.util.Log.e("TopLevelSettingsGrid", "Error in onCreate", e);
        }
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        try {
            ...
            androidx.preference.Preference layoutPref = screen.findPreference("top_level_settings_grid");
            ...
            androidx.recyclerview.widget.RecyclerView rv =
                    lp.findViewById(R.id.top_level_settings_grid_recycler);
            if (rv == null) {
                return;
            }
            ...
            java.util.List<TopLevelSettingsGridAdapter.CardItem> items = new java.util.ArrayList<>();
            
            // Large left card with Quick Settings button
            items.add(new TopLevelSettingsGridAdapter.CardItem(
                    TopLevelSettingsGridAdapter.CARD_TYPE_LARGE_LEFT,
            ...
            // About Us card
            items.add(new TopLevelSettingsGridAdapter.CardItem(
                    TopLevelSettingsGridAdapter.CARD_TYPE_ABOUT_US,
            ...
            // Status bar card
            items.add(new TopLevelSettingsGridAdapter.CardItem(
                    TopLevelSettingsGridAdapter.CARD_TYPE_STATUS_BAR,
            ...
            items.add(new TopLevelSettingsGridAdapter.CardItem(
                    TopLevelSettingsGridAdapter.CARD_TYPE_CIRCULAR_BUTTON,
            ...
            rv.setAdapter(new TopLevelSettingsGridAdapter(activity, items, getMetricsCategory()));
        } catch (Exception e) {
            android.util.Log.e("TopLevelSettingsGrid", "Error setting up TopLevelSettingsGrid", e);
        }
    }
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        try {
            ...
            android.util.Log.e("TopLevelSettingsGrid", "Error in onPreferenceChange", e);
        }
        return false;
    }
