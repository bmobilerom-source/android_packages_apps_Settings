...
/**
 * Fragment for configuring app-specific location permission overrides.
 * Allows users to set different location permissions for individual apps.
 */
@SearchIndexable
public class LocationAppOverridesFragment extends DashboardFragment {
    private static final String TAG = "LocationAppOverrides";
