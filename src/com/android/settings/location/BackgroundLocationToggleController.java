...
/**
 * Controller for background location access toggle preference.
 * When disabled, background location requests are blocked/masked.
 */
public class BackgroundLocationToggleController extends TogglePreferenceController {

    private static final String SETTING_KEY = "location_background_access_enabled";
    private LocationPrivacyManager mPrivacyManager;

    public BackgroundLocationToggleController(Context context, String key) {
        super(context, key);
    ...
    public boolean setChecked(boolean isChecked) {
        ...
        if (success) {
            ...
            Intent intent = new Intent("com.android.settings.location.BACKGROUND_ACCESS_CHANGED");
