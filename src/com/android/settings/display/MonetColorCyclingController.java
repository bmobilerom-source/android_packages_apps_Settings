...
public class MonetColorCyclingController extends BasePreferenceController
    ...
    public MonetColorCyclingController(Context context, String preferenceKey) {
        ...
        if (Settings.Secure.getInt(mContext.getContentResolver(), "monet_color_cycling", 0) == 1) {
            MonetColorCycleScheduler.start(mContext);
        }
    }
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (isEnabled) {
            ...
            MonetColorCycleScheduler.stop(mContext);
        }
