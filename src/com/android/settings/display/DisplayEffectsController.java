...
/**
 * Controller for Display Effects toggle
 */
public class DisplayEffectsController extends TogglePreferenceController {
    ...
    public boolean isChecked() {
        return DisplayCustomizationsHelper.isDisplayEffectsEnabled(mContext);
    }

    @Override
    public boolean setChecked(boolean isChecked) {
        return DisplayCustomizationsHelper.setDisplayEffectsEnabled(mContext, isChecked);
    }
