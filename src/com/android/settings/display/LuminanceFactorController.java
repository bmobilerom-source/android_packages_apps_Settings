...
public class LuminanceFactorController extends SliderPreferenceController {

    private static final String LUMINANCE_FACTOR_KEY = "luminance_factor";
    ...
    public LuminanceFactorController(Context context, String preferenceKey) {
