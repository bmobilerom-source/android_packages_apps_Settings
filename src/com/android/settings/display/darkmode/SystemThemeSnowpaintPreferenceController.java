...
/**
 * Controller for Snowpaint Theme switch preference
 * Maps to SYSTEM_CUSTOM_THEME = 3 (Snowpaint)
 */
public class SystemThemeSnowpaintPreferenceController extends BasePreferenceController
        implements Preference.OnPreferenceChangeListener {

    private static final String TAG = "SystemThemeSnowpaintController";
    private static final String KEY_SYSTEM_THEME_SNOWPAINT = "system_theme_snowpaint";
    private static final int THEME_SNOWPAINT = 3; // Maps to CustomThemeHelper.THEME_SNOWPAINT

    public SystemThemeSnowpaintPreferenceController(Context context, String preferenceKey) {
    ...
    public void updateState(Preference preference) {
        ...
        if (preference instanceof SwitchPreference) {
            ...
            boolean isActive = (currentTheme == THEME_SNOWPAINT);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (enabled) {
            ...
            LineageSettings.Secure.putIntForUser(resolver, "system_theme_espresso", 0, UserHandle.USER_CURRENT);

            // Set SYSTEM_CUSTOM_THEME to Snowpaint (3)
            ...
            Log.d(TAG, "Snowpaint theme enabled, SYSTEM_CUSTOM_THEME set to " + THEME_SNOWPAINT);
        } else {
            ...
            Log.d(TAG, "Snowpaint theme disabled, SYSTEM_CUSTOM_THEME set to 0");
        }
    ...
    private void refreshOtherThemePreferences(Preference currentPreference) {
        ...
        if (espressoPref instanceof SwitchPreference) {
            int currentTheme = Settings.Secure.getIntForUser(
                    mContext.getContentResolver(),
                    Settings.Secure.SYSTEM_CUSTOM_THEME,
                    0,
                    UserHandle.USER_CURRENT);
            ((SwitchPreference) espressoPref).setChecked(currentTheme == 4);
        }
    }
}
