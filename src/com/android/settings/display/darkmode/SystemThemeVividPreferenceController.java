...
/**
 * Controller for Vivid Theme switch preference
 * Maps to SYSTEM_CUSTOM_THEME = 2 (Transparent/Vivid)
 */
public class SystemThemeVividPreferenceController extends BasePreferenceController
        implements Preference.OnPreferenceChangeListener {

    private static final String TAG = "SystemThemeVividController";
    private static final String KEY_SYSTEM_THEME_VIVID = "system_theme_vivid";
    private static final int THEME_VIVID = 2; // Maps to CustomThemeHelper.THEME_TRANSPARENT

    public SystemThemeVividPreferenceController(Context context, String preferenceKey) {
    ...
    public void updateState(Preference preference) {
        ...
        if (preference instanceof SwitchPreference) {
            ...
            boolean isActive = (currentTheme == THEME_VIVID);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (enabled) {
            ...
            // Set SYSTEM_CUSTOM_THEME to Vivid (2)
            ...
            Log.d(TAG, "Vivid theme enabled, SYSTEM_CUSTOM_THEME set to " + THEME_VIVID);
        } else {
            ...
            Log.d(TAG, "Vivid theme disabled, SYSTEM_CUSTOM_THEME set to 0");
        }
